...
class _ApodScreenState extends State<ApodScreen> {
  ...
  GestureDetector _buildCarouselItem(BuildContext context, ApodModel item) {
    ...
    //               tag: 'carousel_${item.date}',
    //               child: ClipRRect(
    //                 // Ye image ke corners ko wrap karega
    ...
    //                   imageUrl:
    //                       item.url ??
    //                           'https://media.istockphoto.com/id/692243858/photo/exoplanet-in-deep-space.jpg?s=612x612&w=0&k=20&c=KQ7B3RI8_D3qeD06RtE7IuEyiDHnLGDg-Hqp8Fe8PXU=',
    //                   width: double.infinity,
    //                   memCacheHeight: 400,
    //                   memCacheWidth: 800,
    ...
    //       ),
    //         Positioned.fill(
    //           child: IgnorePointer( // Taaki border click ko na roke
    //             child: Container(
    //               decoration: BoxDecoration(
    //                 borderRadius: BorderRadius.circular(20.r),
    //                 border: Border.all(
    //                   color: AppColors.surfaceLight.withOpacity(0.8), // Border visible rahega
    //                   width: 1.5.r,
    //                 ),
    //               ),
    //             ),
