...
AsteroidLookUpModel asteroidLookUpModelFromJson(String str) =>
    AsteroidLookUpModel.fromJson(json.decode(str));

String asteroidLookUpModelToJson(AsteroidLookUpModel data) =>
...
class AsteroidLookUpModel {
  ...
  factory AsteroidLookUpModel.fromJson(Map<String, dynamic> json) =>
      AsteroidLookUpModel(
...
class Links {
  ...
  Links copyWith({String? self}) => Links(self: self ?? this.self);

  factory Links.fromJson(Map<String, dynamic> json) =>
      Links(self: json["self"]);
...
class OrbitalData {
  ...
  OrbitalData copyWith({
    ...
    orbitDeterminationDate:
        orbitDeterminationDate ?? this.orbitDeterminationDate,
    ...
    minimumOrbitIntersection:
        minimumOrbitIntersection ?? this.minimumOrbitIntersection,
    jupiterTisserandInvariant:
        jupiterTisserandInvariant ?? this.jupiterTisserandInvariant,
  ...
  factory OrbitalData.fromJson(Map<String, dynamic> json) => OrbitalData(
    ...
    orbitDeterminationDate: json["orbit_determination_date"] == null
        ? null
        : DateTime.parse(json["orbit_determination_date"]),
    firstObservationDate: json["first_observation_date"] == null
        ? null
        : DateTime.parse(json["first_observation_date"]),
    lastObservationDate: json["last_observation_date"] == null
        ? null
        : DateTime.parse(json["last_observation_date"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "first_observation_date": firstObservationDate != null
        ...
        : null,
    "last_observation_date": lastObservationDate != null
